  ...
  dcc.Tab(label='About', children=[ 
       html.Div([
        ...
        html.Div([
            ...
            html.Label('summer=" "'),
            html.Br(),
            html.Label('study=input("What am I currently Studying?")'),
            html.Br(),
            html.Label('print(study)'),
            html.Br(),
            html.Label('>> I am currently studying Computer Engineering at the University of Michigan, Ann Arbor (Class of 2024).'),
            html.Br(),
            html.Br(),
            html.Label('summer=input("What have I been doing this summer?")'),
            html.Label('print(summer)'),
            html.Br(),
